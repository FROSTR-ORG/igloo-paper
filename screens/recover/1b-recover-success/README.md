# Recover — 1b. Recover Success

## Description
This screen captures the `recover` flow state "1b. Recover Success" in the current Igloo web prototype.
...
### Recover Flow
- Recover — 1. Collect Shares — `screens/recover/1-collect-shares/README.md`
