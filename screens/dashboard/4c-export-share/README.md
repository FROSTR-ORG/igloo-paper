...
## Description
This screen captures the `dashboard` flow state "4c. Export Share" in the current Igloo web prototype.

## Paper Source
- **Artboard ID:** 1492-0
- **Artboard Name:** Web — Dashboard — 4c. Export Share
- **Dimensions:** 1440 × 1700

## Flow Context
- **Flow:** `dashboard`
- **State:** `4c. Export Share`
